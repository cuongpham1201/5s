...
> - **2C.1 = SharePoint Data Foundation & Schema — ✅ DONE (design/foundation):** schema cuối Ban5S (`docs/sharepoint/`), types `src/types/sharepoint.ts`, Graph foundation read-only `src/lib/sharepoint/`, field mapping, provisioning + Graph plan. Không write/upload. Verdict: **READY cho 2C.2**.
